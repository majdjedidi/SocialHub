...
const Topbar:React.FC = () => {
  return (
    <div className="flex bg-blue-800 h-14 w-full sticky items-center top-0 z-50">
        ...
        <div className=" basis-4/12 flex items-center justify-around text-white">
            ...
            <img src="assets\person\1.jpg" className=" w-8 h-8 rounded-full object-cover cursor-pointer"alt="" />
        </div>
    </div>
  )
}
